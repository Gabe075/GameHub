...
// Atualizar contagem de jogos no dashboard
document.addEventListener('DOMContentLoaded', () => {
    const totalGamesDashboard = document.getElementById('total-games');
    if (totalGamesDashboard) {
        totalGamesDashboard.textContent = jogos.length;
    }
});
